...
const generateMockData = (): CandlestickData<Time>[] => {
  ...
  for (let i = 100; i >= 0; i--) {
    ...
    const change = basePrice * volatility * Math.random() * trend;
...
export const TradingChart: FC<TradingChartProps> = ({ tokenSymbol, marketCap }) => {
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="text-right">
          ...
          <div className="flex items-center gap-2">
            <span className="text-xl font-bold">${currentPrice.toFixed(6)}</span>
